    ...
    try {
        ...
        const records = [
                ...
                appointments: [
                    {
                        ...
                        treatment:
                            "Rehabilitación con ejercicios de fortalecimiento",
                        observations:
                    ...
                    },
                    {
                        ...
                        treatment:
                            "Continuar con ejercicios, añadir movilidad funcional",
            ...
            new Record({
                ...
                medicalRecord:
                    "Lesión de hombro recurrente, movilidad limitada.",
                appointments: [
                    {
...
mongoose
    .connect("mongodb://localhost:27017/physiocare")
    .then(() => {
